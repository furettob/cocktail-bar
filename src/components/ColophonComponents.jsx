    ...
    links: [
      {
        name: "Github",
        logo: "fa fa-github",
        url: "https://github.com/corradetti-s"
      },
      {
        name: "Linkedin",
        logo: "fa fa-linkedin",
        url: "https://www.linkedin.com/in/marco-corradetti-98a603a9/"
      },
      {
        name: "Docsity",
        logo: "fa fa-globe",
    ...
    links: [
      {
        name: "Github",
        logo: "fa fa-github",
        url: "https://github.com/spensieri-s"
      },
      {
        name: "Linkedin",
        logo: "fa fa-linkedin",
        url: "https://www.linkedin.com/in/sspensieri/"
      },
      {
        name: "Docsity",
        logo: "fa fa-globe",
    ...
    <div className={"cb-colophon"}>
      <Row>
        <p className={"cb-copy cb-copy--muted"}>
          Little web app made and updated with <i className={"fa fa-heart"} />{" "}
          from:
        </p>
