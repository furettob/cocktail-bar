...
exports.addUserWithId = functions.https.onRequest(async (request, response) => {
  console.log("Starting with request method::: ", request.method)
  cors(request, response, async () => {
    try {
      console.log("called addUserWithId")
      if (checker.checkAuthorizedPostReq(request, response) && addUserWithIdDataChecker(request, response)) {
        console.log("Executing with request method::: ", request.method)
        ...
        console.log("STEP2")
        console.log("elemAlreadyPresent: ", elemAlreadyPresent.val())
        if (!!elemAlreadyPresent.val()) {
        ...
        console.log("Not doing nothing with request method::: ", request.method)
      }
    } catch (e) {
